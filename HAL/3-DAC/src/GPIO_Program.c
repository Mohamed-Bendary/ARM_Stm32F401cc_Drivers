...
void GPIO_voidSetPortValue(u8 Copy_u8PortId, u32 Copy_u32PortValue)
{
    ...
    else
    {
        switch(Copy_u8PortId)
        {
            case IOA:   GPIOA->ODR = Copy_u32PortValue;
                        break;
            case IOB:   GPIOB->ODR = Copy_u32PortValue;
                        break;
            case IOC:   GPIOC->ODR = Copy_u32PortValue;
                        break;
        }
    }
}
